...
class Project16 implements ActionListener{
	...
	public Project16(){
		...
		t2=new JTextField(); 
		l1=new JLabel("Write the New Updated Value for Employee Name");
		t1=new JTextField();
	...
	public void actionPerformed(ActionEvent e){
		...
		if(e.getSource()==b1)
		{
			...
			try{
				...
				String qry="update employee  set E_Name=? where E_Id=?";
