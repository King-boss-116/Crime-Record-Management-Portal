...
class Project31 implements ActionListener{
	...
	public Project31(){
		...
		f1.setTitle("Updating Police Name As Admin");
		
		l2=new JLabel("Write the Police Id");
		t2=new JTextField(); 
		l3=new JLabel("Write the Case Involved Id");
		t3=new JTextField(); 
		l1=new JLabel("Write the New Updated Value for Police Name");
		t1=new JTextField();
	...
	public void actionPerformed(ActionEvent e){
		...
		if(e.getSource()==b1)
		{
			...
			try{
				...
				String qry="update police set P_Name=? where P_Id=? and Case_Involoved_Id=?";
