...
class Project33 implements ActionListener{
	...
	public Project33(){
		...
		f1.setTitle("Updating Police Gender As Admin");
		
		l2=new JLabel("Write the Police Id");
		t2=new JTextField(); 
		l3=new JLabel("Write the Case Involved Id");
		t3=new JTextField(); 
		l1=new JLabel("Write the New Updated Value for Police Gender");
		t1=new JTextField();
	...
	public void actionPerformed(ActionEvent e){
		...
		if(e.getSource()==b1)
		{
			...
			try{
				...
				String qry="update police set P_Gender=? where P_Id=? and Case_Involoved_Id=?";
