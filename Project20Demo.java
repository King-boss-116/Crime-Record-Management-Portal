...
class Project20 implements ActionListener{
	...
	public Project20(){
		...
		t2=new JTextField(); 
		l1=new JLabel("Write the New Updated Value for Employee Current Status");
		t1=new JTextField();
	...
	public void actionPerformed(ActionEvent e){
		...
		if(e.getSource()==b1)
		{
			...
			try{
				...
				String qry="update employee  set E_Current_Status=? where E_Id=?";
