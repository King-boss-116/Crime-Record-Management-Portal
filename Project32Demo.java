...
class Project32 implements ActionListener{
	...
	public Project32(){
		...
		f1.setTitle("Updating Police Age As Admin");
		
		l2=new JLabel("Write the Police Id");
		t2=new JTextField(); 
		l3=new JLabel("Write the Case Involved Id");
		t3=new JTextField(); 
		l1=new JLabel("Write the New Updated Value for Police Age");
		t1=new JTextField();
	...
	public void actionPerformed(ActionEvent e){
		...
		if(e.getSource()==b1)
		{
			...
			int c1=Integer.parseInt(t3.getText());
			
			try{
				
				Class.forName("com.mysql.jdbc.Driver");
				Connection con=DriverManager.getConnection("jdbc:mysql://localhost/Dbms_Review?user=root&password=");
				String qry="update police set P_Age=? where P_Id=? and Case_Involoved_Id=?";
