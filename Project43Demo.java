...
class Project43 implements ActionListener{
	...
	public Project43(){
		...
		f1.setTitle("Deleting Police Record As Admin");
		
		l1=new JLabel("Write the Id for Police");
		t1=new JTextField();
	...
	public void actionPerformed(ActionEvent e)
	{
		if(e.getSource()==b1){
			...
			try{
				...
				String qry="delete from police where P_Id=? and Case_Involoved_Id=?";
