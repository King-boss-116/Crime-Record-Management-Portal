...
class Project26 implements ActionListener{
	...
	public Project26(){
		...
		t2=new JTextField(); 
		l1=new JLabel("Write the New Updated Value for Criminal Report-Date");
		t1=new JTextField();
	...
	public void actionPerformed(ActionEvent e){
		...
		if(e.getSource()==b1)
		{
			...
			try{
				...
				String qry="update Criminals  set Report_Date=? where Id=?";
