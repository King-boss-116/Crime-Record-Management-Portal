...
class Project10 implements ActionListener{
	JFrame f1;
	JLabel l1;
	JButton b1,b2,b3;
	...
	{
		if(e.getSource()==b1){
			JOptionPane.showMessageDialog(null,"Directing to Add Employee Record Page");
			new Project7();
		}	
		
		if(e.getSource()==b2){
			JOptionPane.showMessageDialog(null,"Directing to Add Criminal Record Page");
			new Project8();
		}
		
		if(e.getSource()==b3){
			JOptionPane.showMessageDialog(null,"Directing to Add Police Record Page");
			new Project9();
		}
