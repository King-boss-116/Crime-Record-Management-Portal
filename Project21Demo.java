...
class Project21 implements ActionListener{
	...
	public Project21(){
		...
		t2=new JTextField(); 
		l1=new JLabel("Write the New Updated Value for Criminal Name");
		t1=new JTextField();
	...
	public void actionPerformed(ActionEvent e){
		...
		if(e.getSource()==b1)
		{
			...
			try{
				...
				String qry="update Criminals  set name=? where Id=?";
