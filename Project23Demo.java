...
class Project23 implements ActionListener{
	...
	public Project23(){
		...
		t2=new JTextField(); 
		l1=new JLabel("Write the New Updated Value for Criminal Age");
		t1=new JTextField();
	...
	public void actionPerformed(ActionEvent e){
		...
		if(e.getSource()==b1)
		{
			...
			try{
				...
				String qry="update Criminals  set age=? where Id=?";
