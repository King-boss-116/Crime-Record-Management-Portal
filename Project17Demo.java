...
class Project17 implements ActionListener{
	...
	public Project17(){
		...
		f1.setTitle("Updating Employee State As Admin");
		
		l2=new JLabel("Write the Employee Id");
		t2=new JTextField(); 
		l1=new JLabel("Write the New Updated Value for Employee State");
		t1=new JTextField();
	...
	public void actionPerformed(ActionEvent e){
		...
		if(e.getSource()==b1)
		{
			...
			try{
				...
				String qry="update employee  set E_State=? where E_Id=?";
