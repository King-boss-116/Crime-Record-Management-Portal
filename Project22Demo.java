...
class Project22 implements ActionListener{
	...
	public Project22(){
		...
		t2=new JTextField(); 
		l1=new JLabel("Write the New Updated Value for Criminal State");
		t1=new JTextField();
	...
	public void actionPerformed(ActionEvent e){
		...
		if(e.getSource()==b1)
		{
			...
			try{
				...
				String qry="update Criminals  set state=? where Id=?";
